...
class PlansRouter: NSObject, PlansRoutingLogic, PlansDataPassing
{
  ...
  //func navigateToSomewhere(source: PlansViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: PlansDataStore, destination: inout SomewhereDataStore)
  //{
