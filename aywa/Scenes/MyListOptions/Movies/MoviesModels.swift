...
let myListMoviesShowsAndNetworksURL = "/mylist/shows"
    ...
    enum MyListMovies
    {
        struct Request
        {
            func baseRequest() -> BaseRequest {
                ...
                baseRequest.urlPath = myListMoviesShowsAndNetworksURL
                baseRequest.parameters[Constants.kShowTypesKey] = NumericValue.ONE.rawValue
